...
<link href="{{asset('website/css/buttons-fancy.css')}}?v=<?=md5(file_get_contents(asset('website/css/buttons-fancy.css'))); ?>" rel="stylesheet">
<!--<link href="{{asset('website/css/buttons-animated.css')}}" rel="stylesheet">-->
<link href="{{asset('website/css/footer.css')}}?v=<?=md5(file_get_contents(asset('website/css/footer.css'))); ?>" rel="stylesheet">
<link href="{{asset('website/css/style.css')}}?v=<?=md5(file_get_contents(asset('website/css/style.css'))); ?>" rel="stylesheet">
...
script type="text/javascript" src="{{asset('website/js/custom.js')}}?v=<?=md5(file_get_contents(asset('website/js/custom.js'))); ?>"></script>     
        <script>
