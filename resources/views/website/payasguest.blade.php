            ...
            <div class="col-6 text-center">
                <form action="#" method="POST" id="guestcheckoutFrm">
                    ...
                    <div style="margin-top: 0px;" class="discount-block">
                        <div class="mb-3">
                            <label>{{__('trans.Name')}} <span style="color:#ff0000">*</span></label>
                            <input type="text" name="custname" id="custname" class="guestcheckinp" required>
                        </div>
                        <div class="mb-3">
                            <label>{{__('trans.Mobile Number')}} <span style="color:#ff0000">*</span></label>
                ...
                <div class="pay-as-guest row">
                    <div class="text-center col-6">
                        <div class="guest">
                            <a href="javascript:void(0)" id="payasgueast">{{__('trans.Fast Pay')}} (<span>{{ $total_price
                                    }}</span>)</a>
                        </div>
                    ...
                    <div class="col-6">
                        <div class="yellowbg-img cash-on-delivery">
                            <a href="javascript:void(0)" id="cashonD">{{__('trans.Cash or Credit')}}<br>{{__('trans.on Delivery')}}</a>
