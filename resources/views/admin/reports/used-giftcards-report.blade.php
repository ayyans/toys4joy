...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Used Gift Cards Report</h1>
    <div class="d-flex">
  ...
  <div id="filter-container" class="mb-3 border p-3 rounded">
    <form action="{{ route('admin.report.usedGiftCards') }}" method="get">
      <div class="row">
    ...
    <tbody>
      ...
      @foreach ($giftCards as $giftCard)
        <tr>
          ...
          <td>{{ $giftCard['name'] }}</td>
          <td>{{ $giftCard['mobile'] }}</td>
          <td>{{ $giftCard['order_number'] }}</td>
          <td>{{ $giftCard['date_used'] }}</td>
        </tr>
      @endforeach
    </tbody>
  </table>
