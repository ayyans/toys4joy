...
<head>
  ...
  <title>Toys4joy Welcome Email</title><!-- Designed by https://github.com/kaytcat -->
                  ...
                  <td align="center" class="" valign="top">
                    ...
                    <table bgcolor="#fff" cellpadding="0" cellspacing="0" class=""
                      ...
                      <tbody style="margin-top: 15px;">
                        ...
                        <tr class="">
                          <td class="headline">Welcome to Toys4joy</td>
                        </tr>
                        <tr>
                          <td>
                            <center class="">
                                ...
                                <tbody class="">
                                  <tr class="">
                                    <td class="" style="color:#444; font-weight: 400;"><br><br>
                                      Thank you for signing up with Toys4joy! We hope you enjoy your time with us. Check
                                      your account and update your profile.<br>
                                      <br>
                                      Your login credentials are provided below:
                                      <br>
                                      <span style="font-weight:bold;">Name: &nbsp;</span><span
                                        style="font-weight:lighter;" class="">{{ $user->name }}</span>
                                      <br>
