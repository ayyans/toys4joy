...
<div class="pos-view-container p-5 h-600 d-flex flex-column justify-content-between">
    ...
    <div class="text-center mt-4">
        <input type="number" class="border-0 py-3 text-center fw-bolder rounded-lg shadow-sm btn-gold fs-20" wire:model.lazy="updatedPrice">
    </div>
    ...
    <div class="checkout-container p-4 shadow-sm text-dark">
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="border-0 fs-20 text-center fw-bolder rounded-lg shadow-sm btn-gold mb-3 w-100" wire:model="name">
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" class="border-0 fs-20 text-center fw-bolder rounded-lg shadow-sm btn-gold mb-3 w-100" wire:model="phone">
                </td>
            </tr>
            <tr>
                <td>
        ...
        <div id="mid">
            <table>
                ...
                <tr>
                    ...
                    <td class="title">
                        <h2 class="itemtext mb-1">{{ strtoupper($name) }}</h2>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td class="title">
                        <h2 class="itemtext mb-1">{{ $phone }}</h2>
                    </td>
                </tr>
                <tr>
                    <td>
