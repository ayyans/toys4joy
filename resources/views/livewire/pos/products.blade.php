...
<div class="row row-cols-2 align-items-stretch h-500">
    ...
    <div class="pos-product-container p-1" wire:key="{{ $product['code'] }}">
        <div class="pos-product col px-2 py-4 rounded-lg" wire:click="$emit('addProduct', {{ json_encode($product) }})">
