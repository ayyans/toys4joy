...
$(function() {
  ...
  $('#search').on('input', function() {
    ...
    .then(data => {
      ...
      if (search.length > 0 && (products.length > 0 || categories.length > 0 || subCategories.length > 0)) {
      ...
      for (const [index, product] of products.entries()) {
        $('#search-container').append(`
          <div class="${index != 3 ? 'border-bottom' : ''} d-flex align-items-center gap-2 p-2">
              <div>
                  <a href="${product.product_url}">
                      <img src="${product.image}" alt="img-thumbnail rounded" width="70">
                  </a>
              </div>
              <div class="flex-fill">
                  <p class="mb-0 lead">
                      <a href="${product.product_url}" class="text-decoration-none text-reset">
                      ${product.name}
                      </a>
                  </p>
                  <small class="fst-italic"><a href="${product.category_url}" class="text-decoration-none text-reset">${product.category}</a> ${('subcategory' in product) ? ` > <a href="${product.subcategory_url}" class="text-decoration-none text-reset">Pools and Simms</a>` : ''}</small>
