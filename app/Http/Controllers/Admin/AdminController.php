...
// }
    ...
    public function localPointOfSale() {
        return view('admin.local.point-of-sale');
    }

    public function pointOfSale() {
        return view('admin.pos.point-of-sale');
    }
    ...
    public function POSItemsSoldReport(Request $request) {
        ...
        $invoices = POSInvoice::with('products.pos_product', 'products.website_product')->where('type', 'sale')
            ->when($applyFilter, function($query) use ($start_date, $end_date) {
                $query->whereBetween('created_at', [$start_date, $end_date]);
            })
            ->get()
